...
echo -e "\033[92;1m  menghubungi kami admin @DaffVpnStore    \033[0m"
echo -e "\033[92;1m==========================================================\033[0m"
echo ""
sleep 3
clear
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/Daffastorevps/vip/main/REGIST | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
valid=$(curl https://raw.githubusercontent.com/Daffastorevps/vip/main/REGIST | grep $MYIP | awk '{print $3}')
...
Exp1=$(curl https://raw.githubusercontent.com/Daffastorevps/vip/main/REGIST | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/Daffastorevps/vip/main/"
start=$(date +%s)
secs_to_human() {
...
if [[ $(cat /etc/os-release | grep -w ID | head -n1 | sed 's/=//g' | sed 's/"//g' | sed 's/ID//g') == "ubuntu" ]]; then
    echo "Setup Dependencies for Ubuntu 22.04"
    apt update -y
    apt install -y software-properties-common
    apt install -y haproxy
elif [[ $(cat /etc/os-release | grep -w ID | head -n1 | sed 's/=//g' | sed 's/"//g' | sed 's/ID//g') == "debian" ]]; then
    echo "Setup Dependencies for Debian"
...
echo -e "\e[1;32m====================================================$NC"
echo -e "\033[91;1m contoh subdomain :\033[0m \033[93m sub.daffaserver75.my.id\033[0m"
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/Daffastorevps/vip/main/REGIST | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/Daffastorevps/vip/main/REGIST | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"Order","url":"https://t.me/DaffVpnStore"},{"text":"Contack","url":"https://wa.me/6287852291200"}]]}'
...
wget raw.githubusercontent.com/Daffastorevps/vip/main/files/limit.sh && chmod +x limit.sh && ./limit.sh
cd
