...
TIMES="10"
CHATID="-6225527176"
KEY="8181014752:AAEkmn-UYlT7WEZfUweAr3p3AsmJG4D-VE0"
...
EXPSC=$(wget -qO- https://raw.githubusercontent.com/Daffastorevpsum/vip/main/REGIST | grep $ipsaya | awk '{print $3}')
